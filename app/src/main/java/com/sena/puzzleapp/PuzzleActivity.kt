...
class PuzzleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mCurrentPhotoUri = intent.getStringExtra("mCurrentPhotoPath")
        ...
        imageView.post {
            ...
            for (p in pieces!!) {
                ...
                val lParams = p.layoutParams as RelativeLayout.LayoutParams
                lParams.leftMargin = Random.nextInt(
                    layout.width - p.pieceWidth
                )
                lParams.topMargin = layout.height - p.pieceHeight
                p.layoutParams = lParams
    ...
    private fun splitImage():ArrayList<PuzzlePiece> {
        ...
        val croppedBitmap = Bitmap.createBitmap(scaledBitmap ,Math.abs(scaledBitmapLeft),
        ...
        for(row in 0 until rows) {
            ...
            for(col in 0 until cols){
                ...
                if(col==cols -1) {
                    ...
                    path.lineTo(
                        pieceBitmap.width.toFloat(),pieceBitmap.height.toFloat()
    ...
    private fun getBitmapPositionInsideImageView(imageView: ImageView?): IntArray{
        ...
        //Get image position
        //we assume that the the image is centerede into ImageView
